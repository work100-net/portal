...
## <a id="Exception类的层次" style="padding-top: 60px;">Exception类的层次</a>
...
## <a id="Java内置异常类" style="padding-top: 60px;">Java内置异常类</a>
...
## <a id="异常方法" style="padding-top: 60px;">异常方法</a>
...
## <a id="捕获异常" style="padding-top: 60px;">捕获异常</a>
...
## <a id="多重捕获块" style="padding-top: 60px;">多重捕获块</a>
...
## <a id="throws/throw关键字" style="padding-top: 60px;">throws/throw关键字</a>
...
## <a id="finally关键字" style="padding-top: 60px;">finally关键字</a>
...
## <a id="声明自定义异常" style="padding-top: 60px;">声明自定义异常</a>
...
## <a id="通用异常" style="padding-top: 60px;">通用异常</a>
...
上一篇：<a href="/training/java-scanner.html">Scanner类</a>
