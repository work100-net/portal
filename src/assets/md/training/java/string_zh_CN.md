...
## <a id="创建字符串" style="padding-top: 60px;">创建字符串</a>
...
## <a id="字符串长度" style="padding-top: 60px;">字符串长度</a>
...
## <a id="连接字符串" style="padding-top: 60px;">连接字符串</a>
...
## <a id="创建格式化字符串" style="padding-top: 60px;">创建格式化字符串</a>
...
## <a id="String方法" style="padding-top: 60px;">String方法</a>
...
3|i**nt compareTo(String anotherString)** <br />按字典顺序比较两个字符串。
4|i**nt compareToIgnoreCase(String str)** <br />按字典顺序比较两个字符串，不考虑大小写。
...
8|s**tatic String copyValueOf(char[] data, int offset, int count)** <br />返回指定数组中表示该字符序列的 String。
...
上一篇：<a href="/training/java-character.html">Character类</a>

下一篇：<a href="/training/java-stringbuffer.html">StringBuffer</a>
