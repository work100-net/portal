...
## <a id="流(Stream)" style="padding-top: 60px;">流(Stream)</a>

### <a id="读取控制台输入" style="padding-top: 60px;">读取控制台输入</a>
...
### <a id="从控制台读取多字符输入" style="padding-top: 60px;">从控制台读取多字符输入</a>
...
### <a id="从控制台读取字符串" style="padding-top: 60px;">从控制台读取字符串</a>
...
### <a id="控制台输出" style="padding-top: 60px;">控制台输出</a>
...
## <a id="读写文件" style="padding-top: 60px;">读写文件</a>
...
### <a id="FileInputStream" style="padding-top: 60px;">FileInputStream</a>
...
### <a id="FileOutputStream" style="padding-top: 60px;">FileOutputStream</a>
...
## <a id="文件和I/O" style="padding-top: 60px;">文件和I/O</a>
...
### <a id="Java中的目录" style="padding-top: 60px;">Java中的目录</a>
...
上一篇：<a href="/training/java-method.html">方法</a>

下一篇：<a href="/training/java-scanner.html">Scanner类</a>
